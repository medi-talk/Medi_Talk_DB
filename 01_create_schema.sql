...
(
  ...
  dawn_alarm_off_flag BOOLEAN NOT NULL,
...
(
  user_nutrient_id INT AUTO_INCREMENT NOT NULL,
  user_id VARCHAR(50) NOT NULL,
  nutrient_group_name VARCHAR(50) NOT NULL,
...
(
	user_nutrient_id INT NOT NULL,
  nutrient_id INT NOT NULL,
  intake FLOAT NOT NULL,
  PRIMARY KEY(user_nutrient_id, nutrient_id),
  FOREIGN KEY(user_nutrient_id) REFERENCES user_nutrient(user_nutrient_id) ON DELETE CASCADE,
...
(
  ...
  nutrient_id INT NOT NULL,
  gender ENUM('남자', '여자', '영유아') NOT NULL,
  min_age INT NOT NULL,
  max_age INT NOT NULL,
  state ENUM('일반', '임신', '수유') NOT NULL,
